...
export const moneyoneApi = {
  ...
  consentStatus: (template: AaTemplate) =>
    client.get(`/moneyone/${template}/consent/status`),
  ...
  revokeConsent: (template: AaTemplate, consentId?: string) =>
    client.post(`/moneyone/${template}/consent/revoke`, consentId ? { consentId } : {}),
  ...
  ) => client.get(`/moneyone/${template}/accounts/${linkRef}/transactions`, { params: query }),
  ...
  emailTransactions: (template: AaTemplate, linkRef: string, query: Record<string, unknown> = {}) =>
    client.post(`/moneyone/${template}/accounts/${linkRef}/transactions/email`, {}, { params: query }),
  ...
  ) => client.get(`/moneyone/${template}/accounts/${linkRef}/transactions/export`, {
    params: query,
    responseType: 'blob',
  }),
  ...
  sync: (template: AaTemplate, consentId?: string) =>
    client.post(`/moneyone/${template}/sync`, consentId ? { consentId } : {}),
  ...
  getAllData: (template: AaTemplate, consentId: string) =>
    client.get(`/moneyone/${template}/data/${consentId}/all`),
  ...
  getAccountData: (
    ...
    client.get(`/moneyone/${template}/data/${consentId}/account/${linkRef}`, {
      params: page,
    }),

  getAccountBalance: (template: AaTemplate, consentId: string, linkRef: string) =>
    client.get(`/moneyone/${template}/data/${consentId}/account/${linkRef}/balance`),
};
