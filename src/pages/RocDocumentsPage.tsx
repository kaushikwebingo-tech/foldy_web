    ...
    <div className="max-w-3xl">
      ...
      <div className="space-y-4">
        ...
        <ApiCard
          ...
          description="Documents the webhook delivered. Leave Page/Limit blank for the grouped-by-category shape (all 16 MCA buckets at once). Set them for the app's infinite-scroll shape: a flat slice sorted by filingDate desc + hasMore, with categoryCounts included on page 1. Leave Job ID blank for the latest ready job. downloadUrl links are permanent InstaFinancials URLs — we store metadata only, never a file copy."
          onSubmit={() =>
            rocApi.getDocuments({
              ...(jobId ? { jobId } : {}),
              ...(category ? { category } : {}),
        ...
        >
          ...
          <Field label="Page (optional)" value={page} onChange={setPage} placeholder="blank = grouped shape · 1, 2, …" />
          <Field label="Limit (optional)" value={limit} onChange={setLimit} placeholder="docs per page, default 20, max 100" />
        </ApiCard>
